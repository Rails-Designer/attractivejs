...
class Confirm extends ActionBase {
  ...
  #setFeedback(confirmed) {
    ...
    debounce(() => this.currentElement.removeAttribute("data-confirm-success"), parseInt(duration));
  }
}

export const action = (method) => (element, options = {}) => new Confirm(element, options)[method]();
