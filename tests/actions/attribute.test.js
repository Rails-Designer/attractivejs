...
describe("Attribute Actions", () => {
  ...
  describe("toggleAttribute", () => {
    test("adds attribute when not present", () => {
      attributeActions.toggleAttribute(element, {
  ...
  describe("addAttribute", () => {
    test("adds attribute with value", () => {
      attributeActions.addAttribute(element, {
  ...
  describe("setAttribute", () => {
    test("setAttribute sets attribute with value", () => {
      attributeActions.setAttribute(element, {
        value: "data-state=active",
        target: "target"
      });
  ...
  describe("removeAttribute", () => {
    test("removes existing attribute", () => {
      attributeActions.removeAttribute(element, {
        value: "data-existing",
        target: "target"
      });
  ...
  describe("cycleAttribute", () => {
    test("cycles through attribute values", () => {
      attributeActions.cycleAttribute(element, {
        value: "data-theme=light,dark,auto",
        target: "target"
      });
    ...
    test("starts cycle when attribute not present", () => {
      attributeActions.cycleAttribute(element, {
        value: "data-size=small,medium,large",
        target: "target"
      });
  ...
  describe("multiple targets", () => {
    test("operates on multiple elements", () => {
      ...
      attributeActions.addAttribute(trigger, {
        value: "data-active=true",
        targets: "div"
      });
