...
describe("DataAttribute Actions", () => {
  ...
  test("toggleDataAttribute adds data attribute when not present", () => {
    dataAttributeActions.toggleDataAttribute(element, {
      value: "active=true",
      target: "target"
    });
  ...
  test("addDataAttribute sets data attribute with value", () => {
    dataAttributeActions.addDataAttribute(element, {
      value: "status=active",
      target: "target"
    });
  ...
  test("setDataAttribute sets data attribute with value", () => {
    dataAttributeActions.setDataAttribute(element, {
      value: "status=active",
      target: "target"
    });
  ...
  test("removeDataAttribute removes specified data attribute", () => {
    dataAttributeActions.removeDataAttribute(element, {
      value: "existing",
      target: "target"
    });
  ...
  test("cycleDataAttribute cycles through values", () => {
    dataAttributeActions.cycleDataAttribute(element, {
      value: "state=red,blue,green",
      target: "target"
    });
