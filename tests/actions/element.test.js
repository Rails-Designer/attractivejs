  ...
  describe("add", () => {
    test("clones and adds element to target", () => {
      document.body.innerHTML = `
        <button id="trigger" data-element-source="source">Add</button>
        <div id="target"></div>
    ...
    test("adds element at specified position", () => {
      document.body.innerHTML = `
        <button id="trigger" data-element-source="source" data-element-position="afterbegin">Add</button>
    ...
    test("clones template content correctly", () => {
      document.body.innerHTML = `
        <button id="trigger" data-element-source="template">Add</button>
        <div id="target"></div>
    ...
    test("does nothing when no source found", () => {
      document.body.innerHTML = `
        <button id="trigger" data-element-source="nonexistent">Add</button>
        <div id="target"></div>
      `;
      const element = document.getElementById("trigger");
      const target = document.getElementById("target");
